...
/**
 * Client class for handling iteration over node arrays.
 */
class NodeArrayIteratorClient implements Iterator<Node[]> {
  ...
  NodeArrayIteratorClient(String key, String host, String port, String path) {
    this.key = key;
    this.host = host;
    this.port = port;
    this.path = path;
